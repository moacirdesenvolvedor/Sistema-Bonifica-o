...
If EditCodVen.text = ''  then
  begin showmessage('Codigo do Vendedor não pode ser nulo'); abort;
  end;
    begin
    If DBENomeven.text = ''  then
      begin showmessage('Nome do Vendedor não pode ser nulo'); abort;
      end;
        begin
        If DBENovosaldo.text = ''  then
          begin showmessage('Novo Saldo não pode ser nulo'); abort;
          end;
        end;
    end;
  end;
